...
if (!isset($_SESSION['students'])) {
    $_SESSION['students'] = [
        ['id' => 1, 'name' => 'Rahul Sharma', 'branch' => 'Computer Science', 'email' => 'rahul@gmail.com'],
        ['id' => 2, 'name' => 'Priya Singh', 'branch' => 'Information Technology', 'email' => 'priya@gmail.com'],
        ['id' => 3, 'name' => 'Amit Patel', 'branch' => 'Mechanical Engineering', 'email' => 'amit@gmail.com']
    ];
}
